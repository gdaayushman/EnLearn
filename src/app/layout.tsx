...
export const metadata: Metadata = {
  title: "PW Clone — Learn. Practice. Excel.",
  description: "An EdTech platform (Physics Wallah–style) built with Next.js.",
};
    ...
    <html lang="en">
      <body>
        <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/80 backdrop-blur dark:border-slate-800 dark:bg-slate-950/80">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
            <Link href="/" className="flex items-center gap-2 font-bold text-brand-700">
              <span className="grid h-8 w-8 place-items-center rounded-xl bg-brand-600 text-white">PW</span>
              <span>PW Clone</span>
            </Link>
        ...
        <footer className="border-t border-slate-200 py-6 text-center text-sm text-slate-500 dark:border-slate-800">
          © {new Date().getFullYear()} PW Clone • Built with Next.js + Prisma
        </footer>
      </body>
    </html>
  );
